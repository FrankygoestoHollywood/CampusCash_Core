...
/** CampusCash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CampusCashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CampusCashUnits(QObject *parent);
...
typedef CampusCashUnits::Unit CampusCashUnit;
