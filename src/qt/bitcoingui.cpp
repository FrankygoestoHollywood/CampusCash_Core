    ...
    nWeight(0)
{
    ...
    setStyleSheet("#CampusCash { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void CampusCashGUI::createActions()
{
    ...
    fractalUIAction->setToolTip(tr("CCASH Fractal Network"));
...
void CampusCashGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolBar { background: none; } QToolButton { color: #ffffff; background: none; } QToolButton:hover { background-color: rgba(250, 215, 69, 0.6); } QToolButton:checked { background-color: rgba(180, 154, 49, 0.7); } QToolButton:pressed { background-color: rgba(225, 193, 62, 0.7); } #tabs { color: #ffffff; background: none; border: none;}");
    toolbar->setIconSize(QSize(64,64));

    if(!fUseDarkTheme)
    {
        toolbar->setStyleSheet("QToolBar { background: none; } QToolButton { color: #ffffff; background: none;} QToolButton:hover { background-color: rgba(250, 215, 69, 0.7); } QToolButton:checked { background-color: rgba(180, 154, 49, 0.7); } QToolButton:pressed { background-color: rgba(225, 193, 62, 0.7); } #tabs { color: #ffffff; background: none; border: none;}");//QToolBar { background: none; }
    }
...
{
    netLabel->setText("v1.1.0.11");// Version in GUI
...
void CampusCashGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void CampusCashGUI::aboutQtExt_Static()
{
...
void CampusCashGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#CampusCash { background-image: url(:/images/background_light_alt); }");
}
...
void CampusCashGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#CampusCash { background-image: url(:/images/background_light); }");
}
...
void CampusCashGUI::gotoHistoryPage_static()
{
...
void CampusCashGUI::gotoSettingsPage()
{
...
void CampusCashGUI::setWalletUnlockStakingOnly()
{
...
void CampusCashGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void CampusCashGUI::setUnlocked()
{
