// Copyright (c) 2020 The CryptoCoderz Team
...
/**
 * Split CampusCash command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsolesettings::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CampusCash RPC console.") + "<br>" +
