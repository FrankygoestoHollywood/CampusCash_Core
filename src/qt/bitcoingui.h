...
/**
  CampusCash GUI main class. This class represents the main window of the CampusCash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CampusCashGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit CampusCashGUI(QWidget *parent = 0);
    ~CampusCashGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a CampusCash  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
