    ...
    fRestartWarningDisplayed_Lang(false)
{
    ...
    ui->unit->setModel(new CampusCashUnits(this));
...
void OptionsDialog::showRestartWarning_Lang()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting CampusCash."), QMessageBox::Ok);
