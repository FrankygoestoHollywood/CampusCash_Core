...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:CampusCash"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\CampusCash\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\CampusCash.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\CampusCash.lnk"
